...
class BackupScheduler {
  ...
  static Future<void> scheduleAutoBackup(BackupFrequency frequency) async {
    try {
      ...
      // Schedule fallback reminder for OEM devices
  ...
  /// Schedule fallback reminder for aggressive OEMs
  static Future<void> _scheduleFallbackReminder(BackupFrequency frequency) async {
    ...
    try {
      ...
      if (daysSince >= frequency.reminderDays) {
        ...
        if (kDebugMode) {
          print('🔔 Fallback reminder scheduled for OEM device');
        }
      }
    } catch (e) {
      if (kDebugMode) {
        print('💥 Error scheduling fallback reminder: $e');
      }
    }
  }
